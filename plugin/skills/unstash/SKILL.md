---
name: unstash
description: Resume a stashed task: wrap live context first, rebuild the working set at pinned locations, re-dispatch recorded briefs (GUIDE SDD session lifecycle).
argument-hint: "<name>"
